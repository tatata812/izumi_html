	...
	<main>
		<section class="top-about">
			<div class="top-about__inner inner--l">
				<img class="top-about__img" src="<?php echo get_template_directory_uri(); ?>/img/pages/top/about/children.png" alt="子どもたち">
		...
		<section class="top-feature">
			<div class="top-feature__inner inner--m">
				<div class="top-feature__contents">
					...
					<a class="top-feature__button button--lv1" href="<?php echo esc_url( home_url('/about/') ); ?>">
						<span class="text">私たちについて見る</span>
						<i class="icon bi bi-caret-right-fill"></i>
					</a>
				</div>
				<img class="top-feature__img" src="<?php echo get_template_directory_uri(); ?>/img/pages/top/feature/park.png" alt="公園">
			</div>
		</section>
		<section class="top-business">
			<div class="top-business__inner inner--l">
				<img class="top-business__img" src="<?php echo get_template_directory_uri(); ?>/img/pages/top/business/road.jpg" alt="道">
				<div class="top-business__contents">
					...
					<a class="top-business__button button--lv1" href="<?php echo esc_url( home_url('/business/') ); ?>">
		...
		<section class="top-works">
			<div class="top-works__inner inner--m">
				<div class="top-works__contents">
					...
					<a class="top-works__button button--lv2" href="<?php echo esc_url( home_url('/works/') ); ?>">
				...
				<div class="top-works__list">
					...
					<article class="top-works__item">
						<a class="top-works__link" href="<?php the_permalink(); ?>">
							<?php
							$after_image = get_field('after_image');
							?>
							<div class="top-works__thumbnail thumbnail">
								<?php if ($after_image) : ?>
								<img src="<?php echo esc_url($after_image['sizes']['large']); ?>" alt="After｜<?php the_title(); ?>">
								<?php endif; ?>
							</div>
					...
					<a class="top-other__link" href="https://saiyo.page/604260#main" target="_blank">
						<div class="top-other__box">
							<div class="top-other__button">
								...
								<img class="top-other__img" src="<?php echo get_template_directory_uri(); ?>/img/pages/top/other/arrow.png" alt="矢印">
							</div>
						</div>
					</a>
				</li>
				<li class="top-other__item top-other__item--company">
					<a class="top-other__link" href="<?php echo esc_url( home_url('/company/') ); ?>">
						<div class="top-other__box">
							<div class="top-other__button">
								<h2 class="top-other__title heading--lv2">
									<span class="en">
			...
			<div class="top-column__inner inner--m">
				...
				<div class="top-column__list">
					...
					<article class="top-column__item">
						<a class="top-column__link" href="<?php the_permalink(); ?>">
							<div class="top-column__thumbnail thumbnail">
								<?php if (has_post_thumbnail()) : ?>
								<?php the_post_thumbnail('large'); ?>
								<?php endif; ?>
							</div>
							<time class="top-column__time" datetime="<?php echo esc_attr(get_the_date('c')); ?>"><?php echo esc_html(get_the_date('Y.m.d')); ?></time>
							...
							<ul class="top-column__tags">
								...
								<li class="top-column__tag"><?php echo esc_html($term->name); ?></li>
								<?php endforeach; ?>
							</ul>
							<?php endif; ?>
						</a>
				...
				<a class="top-column__button button--lv1" href="<?php echo esc_url( home_url('/column/') ); ?>">
			...
			<div class="top-news__inner inner--s">
				...
				<div class="top-news__list">
					...
					<article class="top-news__item">
						<a class="top-news__link" href="<?php the_permalink(); ?>">
							<time class="top-news__time" datetime="<?php echo esc_attr(get_the_date('c')); ?>"><?php echo esc_html(get_the_date('Y.m.d')); ?></time>
							<div class="top-news__wrapper">
								...
								<ul class="top-news__tags">
									<?php foreach ($terms as $term) : ?>
									<li class="top-news__tag"><?php echo esc_html($term->name); ?></li>
									<?php endforeach; ?>
								</ul>
								<?php endif; ?>
							</div>
				...
				<a class="top-news__button button--lv2" href="<?php echo esc_url( home_url('/news/') ); ?>">
					<span class="text">一覧を見る</span>
					<i class="icon bi bi-caret-right-fill"></i>
				</a>
				<?php endif; ?>
